...
plot=plot+ggtitle("A.")+labs(x="Date")+labs(y="SST anomaly (°C)")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=5),axis.title = element_text(size=5),plot.title = element_text(size=5))
...
plot=plot+ggtitle("B.")+labs(x="Date")+labs(y="El Niño indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=5),axis.title = element_text(size=5),plot.title = element_text(size=5))
...
plot=plot+ggtitle("C.")+labs(x="Date")+labs(y="El Niño indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=5),axis.title = element_text(size=5),plot.title = element_text(size=5))
...
plot=plot+ggtitle("D.")+labs(x="Date")+labs(y="El Niño indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=5),axis.title = element_text(size=5),plot.title = element_text(size=5))
plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="green","Closure periods"="black"))
plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=5))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0))
plot4=plot
plot4

png("/Volumes/SeaGate/BREP/manuscript/figures.06.05.18/fig2.png",width=7, height=5, units="in", res=400)
par(ps=10)
par(mar=c(4,4,1,1))
par(cex=1)
...
## ------------------------------------>figure 3: Local SST anomalies (current decision making process) ####
 ...
 plot=plot+geom_line(data=closures,aes(x=indicator_date,y=one_month_value,group=YR,color="Closure periods"),size=2)
 plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=one_month,color="threshold"))
 plot=plot+ggtitle("B.")+labs(x="Date")+labs(y="Local SST anomaly indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=5),axis.title = element_text(size=5),plot.title = element_text(size=5))
 plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="red","Closure periods"="black"))
 plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=5))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0))
 plot2=plot
 plot2
 ...
 plot=plot+geom_line(data=closures,aes(x=indicator_date,y=two_three_value,group=YR,color="Closure periods"),size=2)
 plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=two_three,color="threshold"))
 plot=plot+ggtitle("C.")+labs(x="Date")+labs(y="Local SST anomaly indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=5),axis.title = element_text(size=5),plot.title = element_text(size=5))
 plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="blue","Closure periods"="black"))
 plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=5))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0))
 plot3=plot
 plot3
 ...
 plot=plot+geom_line(data=closures,aes(x=indicator_date,y=six_month_value,group=YR,color="Closure periods"),size=2)
 plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=six_month,color="threshold"))
 plot=plot+ggtitle("D.")+labs(x="Date")+labs(y="Local SST anomaly indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=5),axis.title = element_text(size=5),plot.title = element_text(size=5))
 plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="green","Closure periods"="black"))
 plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=5))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0))
 plot4=plot
 plot4
 
 png("/Volumes/SeaGate/BREP/manuscript/figures.06.05.18/fig3.png",width=7, height=5, units="in", res=400)
 par(ps=10)
 par(mar=c(4,4,1,1))
 par(cex=1)
 plot_grid(plot1,plot2,plot3,plot4,ncol = 2,nrow = 2)
...
plot=plot+geom_line(data=closures,aes(x=indicator_date,y=six_month_value,group=YR,color="Closure periods"),size=2)
plot=plot+geom_line(data=master,aes(x=indicator_date,y=six_month,color="six-months threshold"),size=.5)
...
plot=plot+labs(x="Date")+labs(y="Local SST anomaly indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=5),axis.title = element_text(size=5),plot.title = element_text(size=5))
plot=plot+scale_color_manual("",values=c("Closure periods"="black","SST anomalies"="black","six-month threshold"="green"),guide=guide_legend(override.aes = list(linetype=c(rep("solid",3)),shape=c(NA,NA)))) +  guides(colour = guide_legend(override.aes = list(size=c(.5,2,.5)))) +theme(legend.key.size = unit(.5,'lines'))+ theme(legend.title=element_text(size=5))
plot=plot+theme(legend.position=c(.2,1),legend.justification = c(.9,.9))+theme(legend.background = element_blank())+theme(legend.text=element_text(size=5))+ theme(legend.key=element_blank()) +scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0))
plot=plot+scale_size_area(name="Turtle data",breaks=c(1,10,50,100),labels=c("One","Ten","50","100"),max_size = 5)+ylim(-1.475,2.3)
plot

png("/Volumes/SeaGate/BREP/manuscript/figures.06.05.18/fig7.png",width=7, height=5, units="in", res=400)
par(ps=10)
par(mar=c(4,4,1,1))
par(cex=1)
plot
