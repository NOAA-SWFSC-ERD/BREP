...
plot=ggplot()+geom_line(data=contemp,aes(x=indicator_date,y=ANOM,color="Niño 3.4 Index"),size=.5)
plot=plot+geom_line(data=closures,aes(x=indicator_date,y=ANOM,group=YR,color="Closure periods"),size=2)
plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=one_month,color="One-month threshold"),size=.5)
plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=two_three,color="Two-months threshold"),size=.5)
plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=six_month,color="Six-months threshold"),size=.5)
plot=plot+ggtitle("A.")+labs(x="Date")+labs(y="SST anomaly (°C)")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=6),axis.title = element_text(size=6),plot.title = element_text(size=6))
plot=plot+scale_color_manual("",values=c("Niño 3.4 Index"="black","One-month threshold"="red","Two-months threshold"="blue","Six-months threshold"="green","Closure periods"="black"),guide=guide_legend(override.aes = list(linetype=c(rep("solid",5))))) +  guides(colour = guide_legend(override.aes = list(size=c(2,.5,.5,.5,.5)))) +theme(legend.key.size = unit(.5,'lines'))
plot=plot+theme(legend.position=c(.4,1.2),legend.justification = c(.9,.9))+theme(legend.background = element_blank())+theme(legend.text=element_text(size=6))+ theme(legend.key=element_blank()) +scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0),limits = as.Date(c('2003-01-01','2017-01-01')))
plot=plot+theme(axis.text.x = element_text(angle = 45),plot.title = element_text(size=6,hjust=0))
plot1=plot
plot1

plot=ggplot()+geom_line(data=contemp,aes(x=indicator_date,y=one_month_value,color="timeseries"))
plot=plot+geom_line(data=closures,aes(x=indicator_date,y=one_month_value,group=YR,color="Closure periods"),size=2)
plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=one_month,color="threshold"))
plot=plot+ggtitle("B.")+labs(x="Date")+labs(y="El Niño indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=6),axis.title = element_text(size=6),plot.title = element_text(size=6))
plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="red","Closure periods"="black"))
plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=6))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0),limits = as.Date(c('2003-01-01','2017-01-01')))
plot=plot+theme(axis.text.x = element_text(angle = 45),plot.title = element_text(size=6,hjust=0))
plot2=plot
plot2

plot=ggplot()+geom_line(data=contemp,aes(x=indicator_date,y=two_three_value,color="timeseries"))
plot=plot+geom_line(data=closures,aes(x=indicator_date,y=two_three_value,group=YR,color="Closure periods"),size=2)
plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=two_three,color="threshold"))
plot=plot+ggtitle("C.")+labs(x="Date")+labs(y="El Niño indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=6),axis.title = element_text(size=6),plot.title = element_text(size=6))
plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="blue","Closure periods"="black"))
plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=6))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0),limits = as.Date(c('2003-01-01','2017-01-01')))
plot=plot+theme(axis.text.x = element_text(angle = 45),plot.title = element_text(size=6,hjust=0))
plot3=plot
plot3
...
plot=plot+ggtitle("D.")+labs(x="Date")+labs(y="El Niño indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=6),axis.title = element_text(size=6),plot.title = element_text(size=6))
plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="green","Closure periods"="black"))
plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=6))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0),limits = as.Date(c('2003-01-01','2017-01-01')))
plot=plot+theme(axis.text.x = element_text(angle = 45),plot.title = element_text(size=6,hjust=0))
plot4=plot
plot4

png("/Volumes/SeaGate/BREP/manuscript/figures.10.15.18/fig2.png",width=7, height=5, units="in", res=400)
par(ps=10)
par(mar=c(4,4,1,1))
par(cex=1)
...
## ------------------------------------>figure 3: Local SST anomalies (current decision making process) ####
 ...
 plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=six_month,color="Six-months threshold"),size=.5)
 plot=plot+ggtitle("A.")+labs(x="Date")+labs(y="SST anomaly (°C)")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=6),axis.title = element_text(size=6),plot.title = element_text(size=6))
 plot=plot+scale_color_manual("",values=c("SST anomalies"="black","One-month threshold"="red","Two-months threshold"="blue","Six-months threshold"="green","Closure periods"="black"),guide=guide_legend(override.aes = list(linetype=c(rep("solid",5))))) +  guides(colour = guide_legend(override.aes = list(size=c(2,.5,.5,.5,.5)))) +theme(legend.key.size = unit(.5,'lines'))
 plot=plot+theme(legend.position=c(.4,1.2),legend.justification = c(.9,.9))+theme(legend.background = element_blank())+theme(legend.text=element_text(size=6))+ theme(legend.key=element_blank()) +scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0),limits = as.Date(c('2003-01-01','2017-01-01')))
 plot=plot+theme(axis.text.x = element_text(angle = 45),plot.title = element_text(size=6,hjust=0))
 plot1=plot
 plot1
 ...
 plot=plot+geom_line(data=closures,aes(x=indicator_date,y=one_month_value,group=YR,color="Closure periods"),size=2)
 plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=one_month,color="threshold"))
 plot=plot+ggtitle("B.")+labs(x="Date")+labs(y="Local SST anomaly indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=6),axis.title = element_text(size=6),plot.title = element_text(size=6))
 plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="red","Closure periods"="black"))
 plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=6))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0),limits = as.Date(c('2003-01-01','2017-01-01')))
 plot=plot+theme(axis.text.x = element_text(angle = 45),plot.title = element_text(size=6,hjust=0))
 plot2=plot
 ...
 plot=plot+geom_line(data=closures,aes(x=indicator_date,y=two_three_value,group=YR,color="Closure periods"),size=2)
 plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=two_three,color="threshold"))
 plot=plot+ggtitle("C.")+labs(x="Date")+labs(y="Local SST anomaly indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=6),axis.title = element_text(size=6),plot.title = element_text(size=6))
 plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="blue","Closure periods"="black"))
 plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=6))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0),limits = as.Date(c('2003-01-01','2017-01-01')))
 plot=plot+theme(axis.text.x = element_text(angle = 45),plot.title = element_text(size=6,hjust=0))
 plot3=plot
 ...
 plot=plot+geom_line(data=closures,aes(x=indicator_date,y=six_month_value,group=YR,color="Closure periods"),size=2)
 plot=plot+geom_line(data=contemp,aes(x=indicator_date,y=six_month,color="threshold"))
 plot=plot+ggtitle("D.")+labs(x="Date")+labs(y="Local SST anomaly indicator")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(axis.text = element_text(size=6),axis.title = element_text(size=6),plot.title = element_text(size=6))
 plot=plot+scale_color_manual("",values=c("timeseries"="black","threshold"="green","Closure periods"="black"))
 plot=plot+theme(legend.background = element_blank())+theme(legend.text=element_text(size=6))+ theme(legend.key=element_blank()) +theme(legend.position="none")+scale_y_continuous(expand = c(0, 0))+scale_x_date(date_breaks="year",date_labels = "%Y",date_minor_breaks = "months",expand = c(0,0),limits = as.Date(c('2003-01-01','2017-01-01')))
 plot=plot+theme(axis.text.x = element_text(angle = 45),plot.title = element_text(size=6,hjust=0))
 plot4=plot
 ...
 png("/Volumes/SeaGate/BREP/manuscript/figures.10.15.18/fig3.png",width=7, height=5, units="in", res=400)
 par(ps=10)
 par(mar=c(4,4,1,1))
 par(cex=1)
 plot_grid(plot1,plot2,plot3,plot4,ncol = 2,nrow = 2)
...
master=read.csv("/Volumes/SeaGate/BREP/BREP/set_in_indicators/sst_box_indicator.csv") %>% mutate(Date=as.Date(Date))
...
### new code 06.05.2018 --> assessing impact if closure was only june july aug
master=data.frame("Indicator"=NA, "Alignment"=NA,"Opertunity Cost"=NA, "% sightings aoided"=NA,"% bycatch avoided"=NA)
...
#0a. ENSO indicators, lines 70-124 of figure 2
#enso=contemp
closures=enso %>% filter(indicator_date>2003)%>% filter(MON=="06" | MON=="07" | MON=="08")
master[1,3]=as.data.frame(table(closures$one_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[2,3]=as.data.frame(table(closures$two_three_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[3,3]=as.data.frame(table(closures$six_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
...
#0b. local anomaly indicators, lines 202-243 of figure 3
#local=contemp
closures=local %>% filter(indicator_date>2003)%>% mutate(MON=month(indicator_date))%>% filter(MON=="6" | MON=="7" | MON=="8")
master[4,3]=as.data.frame(table(closures$one_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[5,3]=as.data.frame(table(closures$two_three_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[6,3]=as.data.frame(table(closures$six_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]

#0c. pelagic sst box indicator, written out in figure 4
closures=box %>% filter(Year>2002)%>% filter(Month=="6" | Month=="7" | Month=="8")
master[7,3]=as.data.frame(table(closures$Status))%>%.[.$Var1=="Closed",]%>%.[1,2]
...
#0a. ENSO indicators, lines 70-124 of figure 2
closures=left_join(pla_sightings,enso) %>% filter(MON=="06" | MON=="07" | MON=="08")
master[1,4]=as.data.frame(table(closures$one_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[2,4]=as.data.frame(table(closures$two_three_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[3,4]=as.data.frame(table(closures$six_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]

#0b. local anomaly indicators, lines 202-243 of figure 3
closures=left_join(pla_sightings,local) %>% mutate(MON=month(indicator_date))%>% filter(MON=="6" | MON=="7" | MON=="8")
master[4,4]=as.data.frame(table(closures$one_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[5,4]=as.data.frame(table(closures$two_three_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[6,4]=as.data.frame(table(closures$six_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
...
#0c. pelagic sst box indicator, written out in figure 4
box=box %>% mutate(indicator_date=as.character(Date))
closures=left_join(pla_sightings,box,by="indicator_date")%>% mutate(MON=month(indicator_date))%>% filter(MON=="6" | MON=="7" | MON=="8")
master[7,4]=as.data.frame(table(closures$Status))%>%.[.$Var1=="Closed",]%>%.[1,2]

#3. % of historical bycatch avoided ##--> 662-664 of table 2
#1a. ENSO indicators, lines 70-124 of figure 2
closures=left_join(turtle_dat,enso,by=c("ym"="indicator_date")) %>% filter(MON=="06" | MON=="07" | MON=="08")
master[1,5]=as.data.frame(table(closures$one_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[2,5]=as.data.frame(table(closures$two_three_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[3,5]=as.data.frame(table(closures$six_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]

#1b. local anomaly indicators, lines 202-243 of figure 3
closures=left_join(turtle_dat,local,by=c("ym"="indicator_date")) %>% arrange(Date)%>% mutate(MON=month(Date))%>% filter(MON=="6" | MON=="7" | MON=="8")
master[4,5]=as.data.frame(table(closures$one_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[5,5]=as.data.frame(table(closures$two_three_status))%>%.[.$Var1=="Closed",]%>%.[1,2]
master[6,5]=as.data.frame(table(closures$six_month_status))%>%.[.$Var1=="Closed",]%>%.[1,2]

#0c. pelagic sst box indicator, written out in figure 4 ##---> from table 2
closures=read.csv("/Volumes/SeaGate/BREP/BREP/set_in_indicators/bycatch_hindcast.csv")%>% filter(MON=="6" | MON=="7" | MON=="8")
master[7,5]=as.data.frame(table(closures$pelagic_box))%>%.[.$Var1=="Closed",]%>%.[1,2]

# ---> adding in new rule, enso and local 6 month average combination
closures=combo %>% filter(indicator_date>2003)%>% mutate(MON=month(indicator_date))%>% filter(MON=="6" | MON=="7" | MON=="8")
master[8,3]=as.data.frame(table(closures$combn))%>%.[.$Var1=="Closed",]%>%.[1,2]

closures=left_join(pla_sightings,combo) %>% mutate(MON=month(indicator_date))%>% filter(MON=="6" | MON=="7" | MON=="8")
master[8,4]=as.data.frame(table(closures$combn))%>%.[.$Var1=="Closed",]%>%.[1,2]

closures=left_join(turtle_dat,combo,by=c("ym"="indicator_date")) %>% arrange(Date)%>% mutate(MON=month(Date))%>% filter(MON=="6" | MON=="7" | MON=="8")
master[8,5]=as.data.frame(table(closures$combn))%>%.[.$Var1=="Closed",]%>%.[1,2]

write.csv(master,"/Volumes/SeaGate/BREP/BREP/set_in_indicators/hindcast_eval_all_indicators_combo_partial.csv")
...
## ------------------------------------> Appendix A - developing the pelagic SST indicator - Table A?, turtle time-series ####
#2 read in turtle time-series
turtdata=load("/Volumes/SeaGate/BREP/BREP/brep_scb_CC_pts_enso34.RData")
pla=readShapeSpatial("/Volumes/SeaGate/BREP/BREP/spatial_files_for_figures/loggerhead.shp")
turtles=scb.cc.xpts
...
coordinates(turtles)=~lon+lat
pla_sightings=raster::intersect(turtles,pla)
pla_sightings@data$lat=pla_sightings@coords[,2]
pla_sightings@data$lon=pla_sightings@coords[,1]
pla_sightings=pla_sightings@data
pla_sightings=pla_sightings %>% dplyr::rename(Date=dtime) 
pla_sightings=pla_sightings%>% dplyr::select(Date,ptt)%>%mutate(ptt=1)
pla_sightings$dt=strtrim(as.character(pla_sightings$Date),4)

a=pla_sightings %>% group_by(dt) %>% dplyr::summarise(count=n())
write.csv(a,"/Volumes/SeaGate/BREP/manuscript/Submission_EcolInd/resumbission/supp_mat/time_series.csv")
